...
public class ProblemController {
	...
	@RequestMapping(value = "/newlist/{labelid}/{page}/{size}", method =
					RequestMethod.GET)
	...
	@RequestMapping(value = "/hotlist/{labelid}/{page}/{size}", method =
					RequestMethod.GET)
	...
	@RequestMapping(value = "/waitlist/{labelid}/{page}/{size}", method =
					RequestMethod.GET)
